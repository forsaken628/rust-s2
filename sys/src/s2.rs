...
const _: () = {
    ["Size of absl_uint128"][::std::mem::size_of::<absl_uint128>() - 16usize];
    ["Alignment of absl_uint128"][::std::mem::align_of::<absl_uint128>() - 16usize];
    ["Offset of field: absl_uint128::lo_"][::std::mem::offset_of!(absl_uint128, lo_) - 0usize];
    ["Offset of field: absl_uint128::hi_"][::std::mem::offset_of!(absl_uint128, hi_) - 8usize];
};
extern "C" {
    #[link_name = "\u{1}_ZN4absl7uint128C1Ef"]
    pub fn absl_uint128_uint128(this: *mut absl_uint128, v: libc::c_float);
}
extern "C" {
    #[link_name = "\u{1}_ZN4absl7uint128C1Ed"]
    pub fn absl_uint128_uint1281(this: *mut absl_uint128, v: libc::c_double);
}
extern "C" {
...
impl absl_uint128 {
    #[inline]
    pub unsafe fn new(v: libc::c_float) -> Self {
        let mut __bindgen_tmp = ::std::mem::MaybeUninit::uninit();
        absl_uint128_uint128(__bindgen_tmp.as_mut_ptr(), v);
        __bindgen_tmp.assume_init()
    }
    #[inline]
    pub unsafe fn new1(v: libc::c_double) -> Self {
        let mut __bindgen_tmp = ::std::mem::MaybeUninit::uninit();
...
extern "C" {
    ...
    pub fn Encoder_reset1(this: *mut Encoder, buf: *mut libc::c_void, maxn: usize);
}
extern "C" {
...
extern "C" {
    #[doc = " Implementation details.  Clients should ignore them."]
    #[link_name = "\u{1}_ZN7EncoderC1EPvm"]
    pub fn Encoder_Encoder1(this: *mut Encoder, buf: *mut libc::c_void, maxn: usize);
}
extern "C" {
...
impl Encoder {
    ...
    #[inline]
    pub unsafe fn reset1(&mut self, buf: *mut libc::c_void, maxn: usize) {
    ...
    #[inline]
    pub unsafe fn new1(buf: *mut libc::c_void, maxn: usize) -> Self {
        let mut __bindgen_tmp = ::std::mem::MaybeUninit::uninit();
...
extern "C" {
    ...
    pub fn Decoder_reset(this: *mut Decoder, buf: *const libc::c_void, maxn: usize);
}
extern "C" {
    #[link_name = "\u{1}_ZN7Decoder4get8Ev"]
    pub fn Decoder_get8(this: *mut Decoder) -> libc::c_uchar;
}
extern "C" {
...
extern "C" {
    ...
    pub fn Decoder_getfloat(this: *mut Decoder) -> libc::c_float;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Decoder9getdoubleEv"]
    pub fn Decoder_getdouble(this: *mut Decoder) -> libc::c_double;
}
extern "C" {
    #[link_name = "\u{1}_ZN7Decoder4getnEPvm"]
    pub fn Decoder_getn(this: *mut Decoder, mem: *mut libc::c_void, n: usize);
}
extern "C" {
    #[link_name = "\u{1}_ZN7Decoder5getcnEPvim"]
    pub fn Decoder_getcn(this: *mut Decoder, mem: *mut libc::c_void, c: libc::c_int, n: usize);
}
extern "C" {
    #[link_name = "\u{1}_ZN7Decoder4getsEPvm"]
    pub fn Decoder_gets(this: *mut Decoder, mem: *mut libc::c_void, n: usize);
}
extern "C" {
    #[link_name = "\u{1}_ZN7Decoder4skipEl"]
    pub fn Decoder_skip(this: *mut Decoder, n: isize) -> *const libc::c_char;
}
extern "C" {
    #[link_name = "\u{1}_ZNK7Decoder3ptrEv"]
    pub fn Decoder_ptr(this: *const Decoder) -> *const libc::c_uchar;
}
extern "C" {
...
extern "C" {
    ...
    pub fn Decoder_Decoder(this: *mut Decoder, buf: *const libc::c_void, maxn: usize);
}
impl Decoder {
    #[inline]
    pub unsafe fn reset(&mut self, buf: *const libc::c_void, maxn: usize) {
        Decoder_reset(self, buf, maxn)
    }
    #[inline]
    pub unsafe fn get8(&mut self) -> libc::c_uchar {
        Decoder_get8(self)
    }
    #[inline]
    ...
    #[inline]
    pub unsafe fn getfloat(&mut self) -> libc::c_float {
        Decoder_getfloat(self)
    }
    #[inline]
    pub unsafe fn getdouble(&mut self) -> libc::c_double {
        Decoder_getdouble(self)
    }
    #[inline]
    pub unsafe fn getn(&mut self, mem: *mut libc::c_void, n: usize) {
        Decoder_getn(self, mem, n)
    }
    #[inline]
    pub unsafe fn getcn(&mut self, mem: *mut libc::c_void, c: libc::c_int, n: usize) {
        Decoder_getcn(self, mem, c, n)
    }
    #[inline]
    pub unsafe fn gets(&mut self, mem: *mut libc::c_void, n: usize) {
        Decoder_gets(self, mem, n)
    }
    #[inline]
    pub unsafe fn skip(&mut self, n: isize) -> *const libc::c_char {
        Decoder_skip(self, n)
    }
    #[inline]
    pub unsafe fn ptr(&self) -> *const libc::c_uchar {
        Decoder_ptr(self)
    }
    #[inline]
    ...
    #[inline]
    pub unsafe fn new(buf: *const libc::c_void, maxn: usize) -> Self {
        let mut __bindgen_tmp = ::std::mem::MaybeUninit::uninit();
...
extern "C" {
    #[link_name = "\u{1}_ZN7S2Error5ClearEv"]
    pub fn S2Error_Clear(this: *mut S2Error);
}
impl S2Error {
    #[inline]
    pub unsafe fn Clear(&mut self) {
...
extern "C" {
    #[link_name = "\u{1}_ZN8S2LatLng8LatitudeERK7S2Point"]
    pub fn S2LatLng_Latitude(p: *const S2Point) -> S1Angle;
}
extern "C" {
    #[link_name = "\u{1}_ZN8S2LatLng9LongitudeERK7S2Point"]
